...
- 源文件：`developer/assets/task-orchestration.drawio`
- 导出图：`public/developer/task-orchestration-overview.svg`
- 导出图：`public/developer/task-orchestration-code-architecture.svg`
- 导出图：`public/developer/task-orchestration-lifecycle.svg`
...
- 在 `draw.io` 中打开 `developer/assets/task-orchestration.drawio`
- 分别导出 3 个 page 为 `svg`
- 导出时优先勾选透明背景、嵌入文本、保持页面尺寸
- 覆盖 `public/developer/` 下对应文件后，VitePress 页面会自动显示正式图


## 页面级任务执行与调度

- 页面级源文件：`developer/assets/page-task-orchestration.drawio`
- 页面级导出图：`public/developer/task-orchestration-actor-page.svg`
- 页面级导出图：`public/developer/task-orchestration-list-page.svg`
- 页面级导出图：`public/developer/task-orchestration-video-page.svg`
